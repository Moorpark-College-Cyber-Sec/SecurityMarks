...
| Folder / Binary                               | Category        | One-Line Purpose / Upstream |
|-----------------------------------------------|-----------------|----------------------------------------------------------------------------------------|
...
| cryptii                                       | Crypto          | Web convert / encode / decode playground — <https://github.com/cryptii/cryptii> |
...
| DB.Browser.for.SQLite-*.AppImage              | DB              | Portable SQLite GUI — <https://sqlitebrowser.org/> |
...
| driftctl                                      | Cloud           | Drift detection for IaC vs live AWS — <https://github.com/snyk/driftctl> |
...
| PEASS-ng                                      | PrivEsc         | Windows/Linux privilege-escalation automation — <https://github.com/carlospolop/PEASS-ng> |
| PrivescCheck                                  | PrivEsc         | Another Windows privesc auditor — <https://github.com/itm4n/PrivescCheck> |
